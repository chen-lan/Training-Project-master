...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        //验证用户名
        User userInfo = userBizImpl.selectUserByUsername(usernamePasswordToken.getUsername());
        if(userInfo==null){
            return null;
        }
////第二个参数是密码，数据库中的密码
        String sqlpassword=userInfo.getPassword();
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(userInfo,sqlpassword,getName());
